...
I personally only have an interest in two targets on the ipq807x platform, and have added a few custom packages as well. If you happen to be building for the Linksys MX4200 v1 and v2, then all you need to do is adjust the R2 output stuff and add secrets for the Discord related things too as it'll fail without the correct changes! 😅
